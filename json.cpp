...
namespace JsonP {
    ...
    protected:
        ...
        void dump(string &out) const override { JsonP::dump(m_value, out); }
    ...
    private:
        ...
        int parser_nint() {
            ...
            switch (curlen) {
                ...
                case 1:
                    ...
                    // u16
                case 2:
                    result = -static_cast<int>(get_uint8()) - 1;
                    break;
                    // u32
                case 4:
                    // todo :overflow
        ...
        void decompose_type(
                int minor_type, uint64_t instant_number, DecodeStatus set_status, size_t setlen = 0) {
            if (minor_type <= 0x17) {
                curlen = setlen;
